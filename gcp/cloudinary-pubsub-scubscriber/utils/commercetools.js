...
const getSecret = async (secretName) => {
    ...
    try {
        ...
        // console.log(`Secret ${secretName} data: ${version.payload.data.toString()}`)

        return version.payload.data.toString().replace("\r\n", "")
    }
    catch (e) {
        console.log("An error occurred while accessing SM")
        console.log(e)
    }
